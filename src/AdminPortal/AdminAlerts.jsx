...
const DEFAULT_CATEGORIES = [
  ...
  { key: "ISSUE", label: "Issues", color: "text-red-600", bg: "bg-red-50", dot: "bg-red-400" },
  { key: "DELAY", label: "Delays", color: "text-red-500", bg: "bg-red-50", dot: "bg-red-300" },
  { key: "GENERAL", label: "General", color: "text-[#8B7355]", bg: "bg-[#FAF7F2]", dot: "bg-[#C5A572]" },
  { key: "FOUNDATION", label: "Foundation", color: "text-[#8B7355]", bg: "bg-[#FAF7F2]", dot: "bg-[#C5A572]" },
  { key: "FRAMING", label: "Framing", color: "text-[#8B7355]", bg: "bg-[#FAF7F2]", dot: "bg-[#C5A572]" },
  { key: "PLUMBING", label: "Plumbing", color: "text-[#8B7355]", bg: "bg-[#FAF7F2]", dot: "bg-[#C5A572]" },
  { key: "ELECTRICAL", label: "Electrical", color: "text-[#8B7355]", bg: "bg-[#FAF7F2]", dot: "bg-[#C5A572]" },
  { key: "ROOFING", label: "Roofing", color: "text-[#8B7355]", bg: "bg-[#FAF7F2]", dot: "bg-[#C5A572]" },
  { key: "INTERIOR", label: "Interior", color: "text-[#8B7355]", bg: "bg-[#FAF7F2]", dot: "bg-[#C5A572]" },
  { key: "EXTERIOR", label: "Exterior", color: "text-[#8B7355]", bg: "bg-[#FAF7F2]", dot: "bg-[#C5A572]" },
  { key: "INSPECTION", label: "Inspection", color: "text-[#8B7355]", bg: "bg-[#FAF7F2]", dot: "bg-[#C5A572]" },
  { key: "HANDOVER", label: "Handover", color: "text-[#8B7355]", bg: "bg-[#FAF7F2]", dot: "bg-[#C5A572]" },
];
