...
export default function SupervisorLoginPage() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (loggedInUser.category !== "site_supervisor") {
        setErrorMessage("This portal is for Site Supervisors only.");
        setLoading(false);
        return;
      }
      ...
      <div className="w-full max-w-xl bg-[#1A1A1A] border border-[#2A2A2A] rounded-2xl p-14 relative z-10 shadow-[0_0_40px_rgba(197,165,114,0.15),0_0_80px_rgba(197,165,114,0.05)]">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-center">
            <span className="px-3 py-1 bg-[#C5A572]/20 rounded-lg text-xs font-semibold text-[#C5A572] tracking-wider">SUPERVISOR PORTAL</span>
          </div>
