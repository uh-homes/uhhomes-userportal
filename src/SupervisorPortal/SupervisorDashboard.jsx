      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
          ...
          <div className="grid grid-cols-2 gap-2">
            <Link to="/supervisor/projects" className="bg-blue-50 text-blue-700 text-sm font-medium rounded-lg px-3 py-2.5 text-center hover:bg-blue-100 transition-colors border border-blue-200">
              View Projects
            </Link>
            <Link to="/supervisor/updates" className="bg-green-50 text-green-700 text-sm font-medium rounded-lg px-3 py-2.5 text-center hover:bg-green-100 transition-colors border border-green-200">
              Post Update
            </Link>
            <Link to="/supervisor/inquiries" className="bg-purple-50 text-purple-700 text-sm font-medium rounded-lg px-3 py-2.5 text-center hover:bg-purple-100 transition-colors border border-purple-200">
              Inquiries
            </Link>
            <Link to="/supervisor/issues" className="bg-red-50 text-red-700 text-sm font-medium rounded-lg px-3 py-2.5 text-center hover:bg-red-100 transition-colors border border-red-200">
              Log Issue
            </Link>
          </div>
        </div>
